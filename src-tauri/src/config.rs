...
fn default_items() -> Vec<crate::types::Action> {
    ...
    vec![
        Action {
            ...
            icon: None,
            enabled: true,
            description: Some("AI Tools Submenu".to_string()),
            children: Some(vec![
                Action {
                ...
                Action {
                    ...
                    icon: None,
                    enabled: true,
                    description: Some("Open Google Gemini".to_string()),
                    children: None,
                },
                Action {
                    id: "grok".to_string(),
                    name: "Grok".to_string(),
                    r#type: ActionType::URL,
                    target: "https://x.ai".to_string(),
                    icon: None,
                    enabled: true,
                    description: Some("Open Grok".to_string()),
                    children: None,
                },
                Action {
                    ...
                    r#type: ActionType::URL,
                    target: "https://www.perplexity.ai".to_string(),
                    icon: None,
                    enabled: true,
                    description: Some("Open Perplexity AI".to_string()),
                    children: None,
                },
                Action {
                    ...
                    r#type: ActionType::URL,
                    target: "https://copilot.microsoft.com".to_string(),
                    icon: None,
                    enabled: true,
                    description: Some("Open Microsoft Copilot".to_string()),
                    children: None,
                },
            ]),
        },
